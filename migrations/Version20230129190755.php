 ...
 */
final class Version20230129190755 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE users (id INT AUTO_INCREMENT NOT NULL, login VARCHAR(60) NOT NULL, password VARCHAR(32) NOT NULL, status SMALLINT NOT NULL, age INT DEFAULT NULL, city VARCHAR(42) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
